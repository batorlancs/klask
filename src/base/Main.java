...
public class Main {
    ...
    public static final double moveSpeed = 0.00003; // movement speed of the player
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // delta time for smooth movement and realistic time
    ...
    public static void resetRound(int who) {
        ...
        // set the ball in the losers corner (random out of 2) (if given who is 0 random out of 4 corners)
        Random rand = new Random();
        if (who == 1) gball = new GameBall(100, 150 + rand.nextInt(2)*250, 30, "YELLOW1");
        else if (who == 2) gball = new GameBall(700, 150 + rand.nextInt(2)*250, 30, "YELLOW1");
        else gball = new GameBall(100 + rand.nextInt(2)*600, 150 + rand.nextInt(2)*250, 30, "YELLOW1");
    }
